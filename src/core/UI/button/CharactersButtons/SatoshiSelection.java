...
public class SatoshiSelection extends Button
{
    
    public SatoshiSelection(GameController game, boolean disable)
    {
        super(game,disable);
    }

    public SatoshiSelection(GameController game, int x, int y, int width, int height, boolean disable)
    {
